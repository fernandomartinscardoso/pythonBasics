# 100 Days of Python
# Day 15 - Requirements of the project
...
#              to make the drink but print: “Sorry there is not enough water.”
...
#           b. But if the user has inserted enough money, then the cost of the drink gets added to the machine as the
